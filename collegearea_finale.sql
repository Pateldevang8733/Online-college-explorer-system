...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2024 at 07:51 PM
...
--
ALTER TABLE `audit_table`
  MODIFY `login_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;

--
-- AUTO_INCREMENT for table `college`
--
ALTER TABLE `college`
  MODIFY `college_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;
